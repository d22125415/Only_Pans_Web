  ...
  pans: [
    {
      ...
      description:
        'It provides even and efficient heat distribution, which saves time and energy and features an ergonomic handle with a hanging hole and two pouring lips.',
      img: [
        {
    ...
    },
    {
      ...
      description:
        'Square pan with a classic grill pattern. Made of cast aluminium, which makes pan heat up quickly and evenly - both on the bottom and on the sides of the pan.',
      img: [
        {
          data: fs.readFileSync(
    ...
    },
    {
      ...
      description:
        'Serve up delicious crepes that look as good as they taste by using this aluminium crepe pan from Vogue. Made from high quality aluminium',
      img: [
        {
          data: fs.readFileSync(
    ...
    },
    {
      ...
      description:
        'Add new and different flavours to your menu, with the help of this flat base wok from Kitchen Craft. With high, sloping walls the wok allows you to easily move food around the surface without spilling it over the sides.',
      img: [
        {
          data: fs.readFileSync(
    ...
    },
    {
      ...
      description:
        '2 handled dishes specifically for the production of paella, ensuring ease of movement and heat distribution during the cooking process.',
      img: [
        {
          data: fs.readFileSync(
